...
export default function VendorForm() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await fetch("https://billing.portstay.com/save-vendor", {
                method: "POST",
                credentials: "include",
                body: data,
                headers: {}
                ...
                return (
                    <View className="space-y-4">
                        ...
                        <View className="space-y-2 p-0 ">
                            <Text className="text-sm font-medium text-gray-600">Supplier Location <Text className="text-red-500">*</Text></Text>
            ...
            case 'address':
                return (
                    <View className="space-y-6">
                        <View className="space-y-4">
                            <Text className="text-lg font-semibold text-gray-800">Supplier Address</Text>
                            <View className="space-y-4">
                                <View className="space-y-2">
    ...
    return (
        <SafeAreaView className="flex-1 bg-gray-50">
            ...
            <View className="p-4 flex-row items-center bg-white border-b border-gray-200">
                ...
                <View>
                    <Text className="text-xl font-bold text-gray-800">Create Vendor</Text>
                </View>
            </View>
            <ScrollView>
                <View className="bg-white">
                    ...
                    <View className="p-4 space-y-4">
                        ...
                        <View className="space-y-2">
                            <Text className="text-sm font-medium text-gray-600">Vendor Display Name <Text className="text-red-500">*</Text></Text>
                            <TextInput
                                className="p-3 border border-gray-200 rounded-lg bg-white"
                        ...
                        <View className="space-y-2">
                            <Text className="text-sm font-medium text-gray-600">Vendor Email Address</Text>
                            <TextInput
                                className="p-3 border border-gray-200 rounded-lg bg-white"
                        ...
                        <View className="space-y-2">
                            <Text className="text-sm font-medium text-gray-600">Vendor Phone</Text>
                            <TextInput
                                className="p-3 border border-gray-200 rounded-lg bg-white"
                                placeholder="Enter phone number"
                                keyboardType="phone-pad"
